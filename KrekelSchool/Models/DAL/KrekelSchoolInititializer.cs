    ...
    public class KrekelSchoolInitializer : DropCreateDatabaseAlways<KrekelSchoolContext>
    {
        ...
        protected override void Seed(KrekelSchoolContext context)
        {
            try
            {
                ...
                context.Mediatheeks.First().VoegBoekToe(new Boek("Tuur is ziek", true, null, 5, "http://www.boekhandelpardoes.be/images/lightbox/9789059241084.jpg", cat, " 9789059241084", "Pascale De Snijder", "Bakermat"));
